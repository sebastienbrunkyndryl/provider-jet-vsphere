...
PROJECT_REPO := github.com/sebastienbrunkyndryl/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-vsphere/2.2.0
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-vsphere_v2.2.0
